  ...
  resources: {
    en: {
      translation: {
        ...
        "projects-description1":
          "Small application through a registration form you can enter a tab where you can leave a comment for the community.",
        "projects-description2":
          "Personal project where I carry out an ecommerce where you can buy, withdraw and edit the quantities of the product and as an administrator you get a table with the user's order to make.",
        "projects-description3":
          "Game in which you will have to find two identical cards until there are no cards left upside down.",
        "projects-description4":
          "Small application of a raffle in which by entering a name a board will be displayed with the available numbers, once the number is saved the option to pay with MercadoPago will be enabled and once the raffle time is over, no more numbers can be purchased.",
        "projects-description5":
          "Project of a football team for the blind, where the players are shown with their personal description, a contact tab, club information and as an administrator you can create and edit players.",
        "projects-description6":
          "MindHub project where different types of events are rendered. It has a search engine that shows the events found, each one has its detail and there is a section of the statistics of the events.",
        "projects-description7":
          "Personal application where I play live videos from youtube and filter according to the selected category.",
        "projects-description8":
          "Page where we will write a sentence and get the result in Braille.",
        "projects-description9":
          "Game in which you will have to click on the pointers that appear to score points and participate for being the best on the podium.",
        "projects-description10":
    ...
    es: {
      translation: {
        ...
        "projects-description1":
          "Pequeña aplicación a través de un formulario de registro puede ingresar a una pestaña donde puede dejar un comentario para la comunidad.",
        "projects-description2":
        ...
        "projects-description4":
          "Pequeña aplicación de una rifa en la que al ingresar un nombre se desplegará un tablero con los números disponibles, una vez guardado el número se habilitará la opción de pagar con MercadoPago y una vez finalizado el tiempo de la rifa no se podrán adquirir más números.",
        "projects-description5":
        ...
        "projects-description6":
          "Proyecto MindHub donde se renderizan diferentes tipos de eventos. Tiene un buscador que muestra los eventos encontrados, cada uno tiene su detalle y hay un apartado de las estadísticas de los eventos.",
        "projects-description7":
          "Aplicacion personal donde reproduzco videos en vivo de youtube y filtra segun la categoria seleccionada.",
        "projects-description8":
          "Pagina donde escribiremos una frase y obtendremos el resultado en Braille.",
        "projects-description9":
          "Juego en el que tendras que clickear en los punteros que aparecen para sumar puntos y participa por ser el mejor en el podio.",
        "projects-description10":
