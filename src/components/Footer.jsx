  ...
  return (
    <footer className='flex w-full justify-around text-4xl mb-5 flex-wrap gap-3'>
        <div className='item-start flex'>
            <a href='Elvio_Galeano.pdf'  target="_blank" rel="noopener noreferrer" download="Elvio_Galeano.pdf" className='text-2xl font-bold font-serif duration-200 hover:text-orange-400' >Descargar CV</a>
        </div>
